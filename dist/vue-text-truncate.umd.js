(function (global, factory) {
  ...
  (global = global || self, factory(global.TextTruncate = {}));
  ...
  __vue_render__._withStripped = true;
    ...
    var __vue_inject_styles__ = function (inject) {
      if (!inject) { return }
      inject("data-v-63dcd187_0", { source: "p[data-v-63dcd187] {\n  height: 100%;\n}\n\n/*# sourceMappingURL=TextTruncate.vue.map */", map: {"version":3,"sources":["C:\\git\\github\\vue-text-truncate\\src\\TextTruncate.vue","TextTruncate.vue"],"names":[],"mappings":"AAqEA;EACA,YAAA;ACpEA;;AAEA,2CAA2C","file":"TextTruncate.vue","sourcesContent":["<template>\r\n  <p>\r\n    <slot></slot>\r\n  </p>\r\n</template>\r\n\r\n\r\n<script>\r\nexport default {\r\n  mounted() {\r\n    console.log(this);\r\n    this.original = this.$slots.default[0].elm.textContent;\r\n\r\n    window.addEventListener(\"resize\", this.resize);\r\n\r\n    this.resize();\r\n  },\r\n\r\n  beforeDestroy() {\r\n    window.removeEventListener(\"resize\", this.resize);\r\n  },\r\n\r\n  methods: {\r\n    resize() {\r\n      if (this.prevWidth === this.$el.clientWidth) return;\r\n\r\n      this.prevWidth = this.$el.clientWidth;\r\n\r\n      // 対象の要素を、高さにautoを指定し非表示で複製する\r\n      const temporary = this.$el.cloneNode(true),\r\n        style = temporary.style;\r\n      let s = this.original;\r\n\r\n      temporary.textContent = this.original;\r\n\r\n      // style.display = \"none\";\r\n      style.position = \"absolute\";\r\n      style.visibility = \"none\";\r\n      style.overflow = \"visible\";\r\n      style.width = this.$el.clientWidth + \"px\";\r\n      style.height = \"auto\";\r\n\r\n      this.$el.appendChild(temporary);\r\n\r\n      // 指定した高さになるまで、20文字ずつ消去していく(最適化のため)\r\n      while (s.length > 0 && temporary.clientHeight > this.$el.clientHeight) {\r\n        s = s.substr(0, s.length - 20);\r\n        temporary.textContent = s + \"...\";\r\n      }\r\n\r\n      s = this.original.substr(0, s.length + 20);\r\n      temporary.textContent = s + \"...\";\r\n\r\n      // 指定した高さになるまで、1文字ずつ消去していく\r\n      while (s.length > 0 && temporary.clientHeight > this.$el.clientHeight) {\r\n        s = s.substr(0, s.length - 1);\r\n        temporary.textContent = s + \"...\";\r\n      }\r\n      this.$el.removeChild(temporary);\r\n\r\n      // 文章を入れ替えて、複製した要素を削除する\r\n      this.$el.textContent = s + \"...\";\r\n    }\r\n  }\r\n};\r\n</script>\r\n\r\n\r\n<style lang=\"scss\" scoped>\r\np {\r\n  height: 100%;\r\n}\r\n</style>\r\n","p {\n  height: 100%;\n}\n\n/*# sourceMappingURL=TextTruncate.vue.map */"]}, media: undefined });

    };
    /* scoped */
    var __vue_scope_id__ = "data-v-63dcd187";
    /* module identifier */
